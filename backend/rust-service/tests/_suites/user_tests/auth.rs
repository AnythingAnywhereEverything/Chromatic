...
#[sqlx::test]
async fn registration_with_invalid_data(pool: PgPool) {
...
#[sqlx::test]
async fn registration_with_special_characters_in_username(pool: PgPool) {
    let ctx = TestContext::new(Some(pool), None).await;
...
#[sqlx::test]
async fn registration_with_various_invalid_payloads(pool: PgPool) {
    let ctx = TestContext::new(Some(pool), None).await;
...
#[sqlx::test]
async fn registration_with_weak_password(pool: PgPool) {
    let ctx = TestContext::new(Some(pool), None).await;
...
#[sqlx::test]
async fn registration_with_short_password(pool: PgPool) {
    let ctx = TestContext::new(Some(pool), None).await;
...
#[sqlx::test]
async fn registration_with_long_but_invalid_password(pool: PgPool) {
    let ctx = TestContext::new(Some(pool), None).await;
...
#[sqlx::test]
async fn duplicate_accounts(pool: PgPool) {
    let ctx = TestContext::new(Some(pool), None).await;
...
#[sqlx::test]
async fn login_with_invalid_credentials(pool: PgPool) {
    let ctx = TestContext::new(Some(pool), None).await;
...
#[sqlx::test]
async fn registration(pool: PgPool) {
    let ctx = TestContext::new(Some(pool), None).await;
...
#[sqlx::test]
async fn login_via_email_and_username(pool: PgPool) {
    let ctx = TestContext::new(Some(pool), None).await;
