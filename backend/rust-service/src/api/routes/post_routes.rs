...
use crate::{
    api::handlers::{
        comment_handler::*, post_handler::{create_new_post_handler, delete_post_handler, get_feed_post_handler, get_post_handler, update_post_handler},
...
pub fn routes() -> Router<SharedState> {
    ...
    .route("/get", get(get_feed_post_handler))
